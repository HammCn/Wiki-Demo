! function() {
    ...
    function h(e, t, r, i) {
        ...
        var a = e._hooks[t],
            o = function(t) {
                var e = a[t];
                if (t >= a.length) i(r);
                else if ("function" == typeof e) if (2 === e.length) e(r, function(e) {
                            r = e, o(t + 1)
                        });
                    else {
                        var n = e(r);
    ...
    var f = !0,
        ...
        g = f && window.history && window.history.pushState && window.history.replaceState && !navigator.userAgent.match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/),
        n = {};
    ...
    function R(e, t) {
        ...
        return e.forEach(function(e) {
            n += '<li><a class="section-link" href="' + e.slug + '">' + e.title + "</a></li>", e.children && (n += R(e.children, t))
        }), t.replace("{inner}", n)
    }
    function r(e, t) {
    ...
    function P(e) {
        var t, n, r = e.loaded,
            i = e.total,
            a = e.step;
        !L && ((n = _("div")).classList.add("progress"), S(y, n), L = n), t = a ? 80 < (t = parseInt(L.style.width || 0, 10) + a) ? 80 : t : Math.floor(r / i * 100), L.style.opacity = 1, L.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(T), T = setTimeout(function(e) {
        ...
        return o.send(), {
            then: function(r, i) {
                if (void 0 === i && (i = p), e) {
                    ...
                    n("progress", P), n("loadend", function(e) {
                        P(e), clearInterval(t)
                    })
                }
    ...
    var M = i(function(m, e) {
        ! function(e) {
            ...
            function l(e) {
                this.tokens = [], this.tokens.links = Object.create(null), this.options = e || f.defaults, this.rules = y.normal, this.options.pedantic ? this.rules = y.pedantic : this.options.gfm && (this.options.tables ? this.rules = y.tables : this.rules = y.gfm)
            }
            y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, y.def = t(y.def).replace("label", y._label).replace("title", y._title).getRegex(), y.bullet = /(?:[*+-]|\d+\.)/, y.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, y.item = t(y.item, "gm").replace(/bull/g, y.bullet).getRegex(), y.list = t(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(), y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", y._comment = /<!--(?!-?>)[\s\S]*?-->/, y.html = t(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), y.paragraph = t(y.paragraph).replace("hr", y.hr).replace("heading", y.heading).replace("lheading", y.lheading).replace("tag", y._tag).getRegex(), y.blockquote = t(y.blockquote).replace("paragraph", y.paragraph).getRegex(), y.normal = g({}, y), y.gfm = g({}, y.normal, {
                fences: /^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\n? *\1 *(?:\n+|$)/,
                paragraph: /^/,
                heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/
            }), y.gfm.paragraph = t(y.paragraph).replace("(?!", "(?!" + y.gfm.fences.source.replace("\\1", "\\2") + "|" + y.list.source.replace("\\1", "\\3") + "|").getRegex(), y.tables = g({}, y.gfm, {
                nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
                table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/
                ...
                def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/
            }), l.rules = y, l.lex = function(e, t) {
                return new l(t).lex(e)
            }, l.prototype.lex = function(e) {
                return e = e.replace(/\r\n|\r/g, "\n").replace(/\t/g, "    ").replace(/\u00a0/g, " ").replace(/\u2424/g, "\n"), this.token(e, !0)
            }, l.prototype.token = function(e, t) {
                var n, r, i, a, o, s, l, c, u, p, h, d, g, f, m, v, b = this;
                for (e = e.replace(/^ +$/gm, ""); e;) if ((i = b.rules.newline.exec(e)) && (e = e.substring(i[0].length), 1 < i[0].length && b.tokens.push({
                        type: "space"
                    })), i = b.rules.code.exec(e)) e = e.substring(i[0].length), i = i[0].replace(/^ {4}/gm, ""), b.tokens.push({
                            type: "code",
                            text: b.options.pedantic ? i : w(i, "\n")
                        });
                    else if (i = b.rules.fences.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "code",
                        lang: i[2],
                        text: i[3] || ""
                    });
                else if (i = b.rules.heading.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "heading",
                        depth: i[1].length,
                        text: i[2]
                    });
                else if (t && (i = b.rules.nptable.exec(e)) && (s = {
                    type: "table",
                    ...
                    b.tokens.push(s)
                } else if (i = b.rules.hr.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "hr"
                    });
                else if (i = b.rules.blockquote.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "blockquote_start"
                    }), i = i[0].replace(/^ *> ?/gm, ""), b.token(i, t), b.tokens.push({
                        type: "blockquote_end"
                    });
                ...
                } else if (i = b.rules.html.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: b.options.sanitize ? "paragraph" : "html",
                        pre: !b.options.sanitizer && ("pre" === i[1] || "script" === i[1] || "style" === i[1]),
                        text: i[0]
                    });
                else if (t && (i = b.rules.def.exec(e))) e = e.substring(i[0].length), i[3] && (i[3] = i[3].substring(1, i[3].length - 1)), d = i[1].toLowerCase().replace(/\s+/g, " "), b.tokens.links[d] || (b.tokens.links[d] = {
                        href: i[2],
                        title: i[3]
                    });
                else if (t && (i = b.rules.table.exec(e)) && (s = {
                    type: "table",
                    header: k(i[1].replace(/^ *| *\| *$/g, "")),
                    align: i[2].replace(/^ *|\| *$/g, "").split(/ *\| */),
                    cells: i[3] ? i[3].replace(/(?: *\| *)?\n$/, "").split("\n") : []
                    ...
                    for (e = e.substring(i[0].length), h = 0; h < s.align.length; h++) /^ *-+: *$/.test(s.align[h]) ? s.align[h] = "right" : /^ *:-+: *$/.test(s.align[h]) ? s.align[h] = "center" : /^ *:-+ *$/.test(s.align[h]) ? s.align[h] = "left" : s.align[h] = null;
                    for (h = 0; h < s.cells.length; h++) s.cells[h] = k(s.cells[h].replace(/^ *\| *| *\| *$/g, ""), s.header.length);
                    b.tokens.push(s)
                } else if (i = b.rules.lheading.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "heading",
                        depth: "=" === i[2] ? 1 : 2,
                        text: i[1]
                    });
                else if (t && (i = b.rules.paragraph.exec(e))) e = e.substring(i[0].length), b.tokens.push({
                        type: "paragraph",
                        text: "\n" === i[1].charAt(i[1].length - 1) ? i[1].slice(0, -1) : i[1]
                    });
                else if (i = b.rules.text.exec(e)) e = e.substring(i[0].length), b.tokens.push({
                        type: "text",
                        text: i[0]
                    });
            ...
            function c(e, t) {
                if (this.options = t || f.defaults, this.links = e, this.rules = n.normal, this.renderer = this.options.renderer || new r, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
            ...
            function i() {}
            function u(e) {
                this.tokens = [], this.token = null, this.options = e || f.defaults, this.options.renderer = this.options.renderer || new r, this.renderer = this.options.renderer, this.renderer.options = this.options
            }
            function p(e, t) {
                if (t) {
                    if (p.escapeTest.test(e)) return e.replace(p.escapeReplace, function(e) {
                            return p.replacements[e]
                        })
                } else if (p.escapeTestNoEncode.test(e)) return e.replace(p.escapeReplaceNoEncode, function(e) {
                        return p.replacements[e]
                    });
                return e
            }
            ...
            function a(e, t) {
                return o[" " + e] || (/^[^:]+:\/*[^/]*$/.test(e) ? o[" " + e] = e + "/" : o[" " + e] = w(e, "/", !0)), e = o[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^/]*)[\s\S]*/, "$1") + t : e + t
            }
            n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, n.autolink = t(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = t(n.tag).replace("comment", y._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, n._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f\\]*\)|[^\s\x00-\x1f()\\])*?)/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = t(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = t(n.reflink).replace("label", n._label).getRegex(), n.normal = g({}, n), n.pedantic = g({}, n.normal, {
            ...
            }), n.gfm.url = t(n.gfm.url).replace("email", n.gfm._extended_email).getRegex(), n.breaks = g({}, n.gfm, {
                ...
                for (var t, n, r, i, a, o, s = this, l = ""; e;) if (a = s.rules.escape.exec(e)) e = e.substring(a[0].length), l += a[1];
                    else if (a = s.rules.autolink.exec(e)) e = e.substring(a[0].length), r = "@" === a[2] ? "mailto:" + (n = p(s.mangle(a[1]))) : n = p(a[1]), l += s.renderer.link(r, null, n);
                else if (s.inLink || !(a = s.rules.url.exec(e))) {
                    if (a = s.rules.tag.exec(e))!s.inLink && /^<a /i.test(a[0]) ? s.inLink = !0 : s.inLink && /^<\/a>/i.test(a[0]) && (s.inLink = !1), !s.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(a[0]) ? s.inRawBlock = !0 : s.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (s.inRawBlock = !1), e = e.substring(a[0].length), l += s.options.sanitize ? s.options.sanitizer ? s.options.sanitizer(a[0]) : p(a[0]) : a[0];
                    else if (a = s.rules.link.exec(e)) e = e.substring(a[0].length), s.inLink = !0, r = a[2], i = s.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], t[3]) : "" : a[3] ? a[3].slice(1, -1) : "", r = r.trim().replace(/^<([\s\S]*)>$/, "$1"), l += s.outputLink(a, {
                            href: c.escapes(r),
                            title: c.escapes(i)
                        }), s.inLink = !1;
                    else if ((a = s.rules.reflink.exec(e)) || (a = s.rules.nolink.exec(e))) {
                        if (e = e.substring(a[0].length), t = (a[2] || a[1]).replace(/\s+/g, " "), !(t = s.links[t.toLowerCase()]) || !t.href) {
                            l += a[0].charAt(0), e = a[0].substring(1) + e;
                            continue
                        }
                        s.inLink = !0, l += s.outputLink(a, t), s.inLink = !1
                    } else if (a = s.rules.strong.exec(e)) e = e.substring(a[0].length), l += s.renderer.strong(s.output(a[4] || a[3] || a[2] || a[1]));
                    else if (a = s.rules.em.exec(e)) e = e.substring(a[0].length), l += s.renderer.em(s.output(a[6] || a[5] || a[4] || a[3] || a[2] || a[1]));
                    else if (a = s.rules.code.exec(e)) e = e.substring(a[0].length), l += s.renderer.codespan(p(a[2].trim(), !0));
                    else if (a = s.rules.br.exec(e)) e = e.substring(a[0].length), l += s.renderer.br();
                    else if (a = s.rules.del.exec(e)) e = e.substring(a[0].length), l += s.renderer.del(s.output(a[1]));
                    else if (a = s.rules.text.exec(e)) e = e.substring(a[0].length), s.inRawBlock ? l += s.renderer.text(a[0]) : l += s.renderer.text(p(s.smartypants(a[0])));
                    else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                } else {
                ...
                return "!" !== e[0].charAt(0) ? this.renderer.link(n, r, this.output(e[1])) : this.renderer.image(n, r, p(e[1]))
                ...
                this.inline = new c(e.links, this.options), this.inlineText = new c(e.links, g({}, this.options, {
                    renderer: new i
                ...
                switch (this.token.type) {
                    ...
                    case "blockquote_start":
                        for (o = "";
                        "blockquote_end" !== this.next().type;) o += e.tok();
                        return this.renderer.blockquote(o);
                    case "list_start":
                        o = "";
                        for (var s = this.token.ordered, l = this.token.start;
                        "list_end" !== this.next().type;) o += e.tok();
                        return this.renderer.list(o, s, l);
                    case "list_item_start":
                        o = "";
                        var c = this.token.loose;
                        for (this.token.task && (o += this.renderer.checkbox(this.token.checked));
                        "list_item_end" !== this.next().type;) o += c || "text" !== e.token.type ? e.tok() : e.parseText();
            ...
            }, p.escapeTest = /[&<>"']/, p.escapeReplace = /[&<>"']/g, p.replacements = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
                '"': "&quot;",
                "'": "&#39;"
            }, p.escapeTestNoEncode = /[<>"']|&(?!#?\w+;)/, p.escapeReplaceNoEncode = /[<>"']|&(?!#?\w+;)/g;
            var o = {}, s = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;

            function d() {}
            function g(e) {
                for (var t, n, r = arguments, i = 1; i < arguments.length; i++) for (n in t = r[i]) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
                return e
            }
            function k(e, t) {
            ...
            function f(e, n, r) {
                ...
                if (r || "function" == typeof n) {
                    r || (r = n, n = null);
                    var i, a, o = (n = g({}, f.defaults, n || {})).highlight,
                        t = 0;
                    try {
                        i = l.lex(e, n)
                    } catch (e) {
                    ...
                    if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (n || f.defaults).silent) return "<p>An error occurred:</p><pre>" + p(e.message + "", !0) + "</pre>";
                    throw e
                }
            }
            d.exec = d, f.options = f.setOptions = function(e) {
            ...
            }, f.defaults = f.getDefaults(), f.Parser = u, f.parser = u.parse, f.Renderer = r, f.TextRenderer = i, f.Lexer = l, f.lexer = l.lex, f.InlineLexer = c, f.inlineLexer = c.output, f.parse = f, m.exports = f
        }(t || "undefined" != typeof window && window)
    }),
        a = i(function(e) {
            var c = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}, u = function() {
                    var l = /\blang(?:uage)?-([\w-]+)\b/i,
                        ...
                        P = c.Prism = {
                            ...
                            util: {
                                encode: function(e) {
                                    return e instanceof o ? new o(e.type, P.util.encode(e.content), e.alias) : "Array" === P.util.type(e) ? e.map(P.util.encode) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                                },
                                type: function(e) {
                                ...
                                clone: function(e, n) {
                                    ...
                                    switch (n = n || {}, t) {
                                        case "Object":
                                            ...
                                            var r = {};
                                            for (var i in n[P.util.objId(e)] = r, e) e.hasOwnProperty(i) && (r[i] = P.util.clone(e[i], n));
                                            return r;
                                        case "Array":
                                            if (n[P.util.objId(e)]) return n[P.util.objId(e)];
                                            r = [];
                                            return n[P.util.objId(e)] = r, e.forEach(function(e, t) {
                            ...
                            languages: {
                                ...
                                insertBefore: function(n, e, t, r) {
                                    ...
                                    return P.languages.DFS(P.languages, function(e, t) {
                                        t === r[n] && e != n && (this[e] = o)
                                    }), r[n] = o
                                },
                                DFS: function(e, t, n, r) {
                                    for (var i in r = r || {}, e) e.hasOwnProperty(i) && (t.call(e, i, e[i], n || i), "Object" !== P.util.type(e[i]) || r[P.util.objId(e[i])] ? "Array" !== P.util.type(e[i]) || r[P.util.objId(e[i])] || (r[P.util.objId(e[i])] = !0, P.languages.DFS(e[i], t, i, r)) : (r[P.util.objId(e[i])] = !0, P.languages.DFS(e[i], t, null, r)))
                                }
                            },
                            plugins: {},
                            ...
                            highlightAllUnder: function(e, t, n) {
                                ...
                                for (var i, a = r.elements || e.querySelectorAll(r.selector), o = 0; i = a[o++];) P.highlightElement(i, !0 === t, r.callback)
                            },
                            highlightElement: function(e, t, n) {
                                for (var r, i, a = e; a && !l.test(a.className);) a = a.parentNode;
                                a && (r = (a.className.match(l) || [, ""])[1].toLowerCase(), i = P.languages[r]), e.className = e.className.replace(l, "").replace(/\s+/g, " ") + " language-" + r, e.parentNode && (a = e.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(l, "").replace(/\s+/g, " ") + " language-" + r));
                                var o = {
                                    element: e,
                                    language: r,
                                    grammar: i,
                                ...
                                if (P.hooks.run("before-sanity-check", o), !o.code || !o.grammar) return o.code && (P.hooks.run("before-highlight", o), o.element.textContent = o.code, P.hooks.run("after-highlight", o)), void P.hooks.run("complete", o);
                                if (P.hooks.run("before-highlight", o), t && c.Worker) {
                                    var s = new Worker(P.filename);
                                    s.onmessage = function(e) {
                                        o.highlightedCode = e.data, P.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, n && n.call(o.element), P.hooks.run("after-highlight", o), P.hooks.run("complete", o)
                                    }, s.postMessage(JSON.stringify({
                                        language: o.language,
                                        code: o.code,
                                        immediateClose: !0
                                    }))
                                } else o.highlightedCode = P.highlight(o.code, o.grammar, o.language), P.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, n && n.call(e), P.hooks.run("after-highlight", o), P.hooks.run("complete", o)
                            },
                            highlight: function(e, t, n) {
                                ...
                                return P.hooks.run("before-tokenize", r), r.tokens = P.tokenize(r.code, r.grammar), P.hooks.run("after-tokenize", r), o.stringify(P.util.encode(r.tokens), r.language)
                            },
                                            ...
                                            for (var b = r, y = i; b < t.length; y += t[b].length, ++b) {
                                                ...
                                                if (!(k instanceof s)) {
                                                    if (g && b != t.length - 1) {
                                                        ...
                                                        for (var w = C.index + (d ? C[1].length : 0), x = C.index + C[0].length, _ = b, S = y, A = t.length; _ < A && (S < x || !t[_].type && !t[_ - 1].greedy); ++_)(S += t[_].length) <= w && (++b, y = S);
                                                        ...
                                                        if (T.push(R), L && T.push(L), Array.prototype.splice.apply(t, T), 1 != E && P.matchGrammar(e, t, n, b, y, !0, l), a) break
                                                    } else if (a) break
                                                }
                                            }
                                        }
                    ...
                    if (o.stringify = function(t, n, e) {
                        if ("string" == typeof t) return t;
                        if ("Array" === P.util.type(t)) return t.map(function(e) {
                    ...
                    }, !c.document) return c.addEventListener && (P.disableWorkerMessageHandler || c.addEventListener("message", function(e) {
                    ...
                    return e && (P.filename = e.src, P.manual || e.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(P.highlightAll) : window.setTimeout(P.highlightAll, 16) : document.addEventListener("DOMContentLoaded", P.highlightAll))), c.Prism
                }();
            e.exports && (e.exports = u), void 0 !== t && (t.Prism = u), u.languages.markup = {
                comment: /<!--[\s\S]*?-->/,
                prolog: /<\?[\s\S]+?\?>/,
                ...
                entity: /&#?[\da-z]{1,8};/i
            }, u.languages.markup.tag.inside["attr-value"].inside.entity = u.languages.markup.entity, u.hooks.add("wrap", function(e) {
                "entity" === e.type && (e.attributes.title = e.content.replace(/&amp;/, "&"))
            }), u.languages.xml = u.languages.markup, u.languages.html = u.languages.markup, u.languages.mathml = u.languages.markup, u.languages.svg = u.languages.markup, u.languages.css = {
                comment: /\/\*[\s\S]*?\*\//,
                atrule: {
                    pattern: /@[\w-]+?.*?(?:;|(?=\s*\{))/i,
                    inside: {
                ...
                function: /[-a-z0-9]+(?=\()/i,
                punctuation: /[(){};:]/
            }, u.languages.css.atrule.inside.rest = u.languages.css, u.languages.markup && (u.languages.insertBefore("markup", "tag", {
                style: {
            ...
            }), u.languages.insertBefore("inside", "attr-value", {
                "style-attr": {
            ...
            }, u.languages.markup.tag)), u.languages.clike = {
                comment: [{
                        pattern: /(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,
                        lookbehind: !0
                    }, {
            ...
            }), u.languages.javascript["template-string"].inside.interpolation.inside.rest = u.languages.javascript, u.languages.markup && u.languages.insertBefore("markup", "tag", {
                script: {
            ...
            }), u.languages.js = u.languages.javascript, "undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function() {
                var l = {
                    js: "javascript",
                    py: "python",
                    rb: "ruby",
                ...
                Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function(e) {
                    ...
                    s.open("GET", n, !0), s.onreadystatechange = function() {
                        4 == s.readyState && (s.status < 400 && s.responseText ? (o.textContent = s.responseText, u.highlightElement(o)) : 400 <= s.status ? o.textContent = "✖ Error " + s.status + " while fetching file: " + s.statusText : o.textContent = "✖ Error: File does not exist or is empty")
                    }, s.send(null)
                }), u.plugins.toolbar && u.plugins.toolbar.registerButton("download-file", function(e) {
    ...
    Prism.languages["markup-templating"] = {}, Object.defineProperties(Prism.languages["markup-templating"], {
        buildPlaceholders: {
            value: function(n, r, e, i) {
                n.language === r && (n.tokenStack = [], n.code = n.code.replace(e, function(e) {
                    if ("function" == typeof i && !i(e)) return e;
                    for (var t = n.tokenStack.length; - 1 !== n.code.indexOf("___" + r.toUpperCase() + t + "___");)++t;
            ...
            value: function(p, h) {
                if (p.language === h && p.tokenStack) {
                    ...
                    var d = 0,
                        ...
                        f = function(e) {
                            if (!(d >= g.length)) for (var t = 0; t < e.length; t++) {
                                    var n = e[t];
                                    if ("string" == typeof n || n.content && "string" == typeof n.content) {
                                        ...
                                        if (-1 < o) {
                                            ++d;
                                            var s, l = a.substring(0, o),
                                                c = new Prism.Token(h, Prism.tokenize(i, p.grammar, h), "language-" + h, i),
                                                u = a.substring(o + ("___" + h.toUpperCase() + r + "___").length);
                                            if (l || u ? (s = [l, c, u].filter(function(e) {
                                                return !!e
                                            }), f(s)) : s = c, "string" == typeof n ? Array.prototype.splice.apply(e, [t, 1].concat(s)) : n.content = s, d >= g.length) break
                                        }
    ...
    function te(e) {
        void 0 === e && (e = "");
        var r = {};
        return e && (e = e.replace(/^'/, "").replace(/'$/, "").replace(/:([\w-]+)=?([\w-]+)?/g, function(e, t, n) {
    ...
    var ne = {
        ...
        code: function(e, t) {
            ...
            var a = this;
            this.config = i, this.router = e, this.cacheTree = {}, this.toc = [], this.cacheTOC = {}, this.linkTarget = i.externalLinkTarget || "_blank", this.contentBase = e.getBasePath();
            var o, t = this._initRenderer(),
                n = i.markdown || {};
            o = u(n) ? n(M, t) : (M.setOptions(d(n, {
                renderer: d(t, n.renderer)
            })), M), this._marked = o, this.compile = function(n) {
                var r = !0,
                    e = s(function(e) {
                        r = !1;
                        var t = "";
                        return n ? (t = c(n) ? o(n) : o.parser(n), t = i.noEmoji ? t : t.replace(/<(pre|template|code)[^>]*?>[\s\S]+?<\/(pre|template|code)>/g, function(e) {
                            return e.replace(/:/g, "__colon__")
                        }).replace(/:(\w+?):/gi, f && window.emojify || D).replace(/__colon__/g, ":"), U.clear(), t) : n
                    })(n),
    ...
    re.prototype.compileEmbed = function(e, t) {
        ...
        if (t = i, a.include) {
            var o;
            if (X(e) || (e = J(this.contentBase, Q(this.router.getCurrentPath()), e)), a.type && (o = ne[a.type]))(n = o.call(this, e, t)).type = a.type;
            else {
                var s = "code";
                /\.(md|markdown)/.test(e) ? s = "markdown" : /\.mmd/.test(e) ? s = "mermaid" : /\.html?/.test(e) ? s = "iframe" : /\.(mp4|ogg)/.test(e) ? s = "video" : /\.mp3/.test(e) && (s = "audio"), (n = ne[s].call(this, e, t)).type = s
            }
            return n
        }
        ...
        var e = new M.Renderer,
            ...
            l = this,
            t = {};
        return t.heading = e.heading = function(e, t) {
            var n = te(e),
                r = n.str,
                i = n.config,
                a = {
            ...
            var o = U(i.id || r),
                s = u.toURL(u.getCurrentPath(), {
                    id: o
                });
            return a.slug = s, l.toc.push(a), "<h" + t + ' id="' + o + '"><a href="' + s + '" data-id="' + o + '" class="anchor"><span>' + r + "</span></a></h" + t + ">"
        }, t.code = e.code = function(e, t) {
            return void 0 === t && (t = ""), e = e.replace(/@DOCSIFY_QM@/g, "`"), '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + a.highlight(e, a.languages[t] || a.languages.markup) + "</code></pre>"
            ...
            var r = "",
                ...
                a = i.str,
                o = i.config;
            return t = a, X(e) || l._matchNotCompileLink(e) || o.ignore ? r += 0 === e.indexOf("mailto:") ? "" : ' target="' + s + '"' : (e === l.config.homepage && (e = "README"), e = u.toURL(e, null, u.getCurrentPath())), o.target && (r += " target=" + o.target), o.disabled && (r += " disabled", e = "javascript:void(0)"), t && (r += ' title="' + t + '"'), '<a href="' + e + '"' + r + ">" + n + "</a>"
            ...
            return X(e) || (r = J(p, Q(u.getCurrentPath()), e)), '<img src="' + r + '"data-origin="' + e + '" alt="' + n + '"' + i + ">"
        }, e.origin = t, e
    ...
    function ae() {
        ...
        if (e) {
            ...
            window.pageYOffset >= t || e.classList.contains("hidden") ? $(y, "add", "sticky") : $(y, "remove", "sticky")
        }
    }
    function oe(e, t, r, n) {
        var i, a = x(t = v(t), "a"),
        ...
        }), n && (b.title = i ? i.title || i.innerText + " - " + ie : ie), i
    }
    var se = function() {
        function r(e, t) {
    ...
    var le = function() {
        function t() {
            ...
            }(this, t), this.duration = e.duration || 1e3, this.ease = e.easing || this._defaultEase, this.start = e.start, this.end = e.end, this.frame = null, this.next = null, this.isRunning = !1, this.events = {}, this.direction = this.start < this.end ? "up" : "down"
        }
        return se(t, [{
                key: "begin",
                value: function() {
    ...
    function ge(e) {
        if (he) {
            for (var t, n = v(".sidebar"), r = x(".anchor"), i = w(n, ".sidebar-nav"), a = w(n, "li.active"), o = document.documentElement, s = (o && o.scrollTop || document.body.scrollTop) - de, l = 0, c = r.length; l < c; l += 1) {
                var u = r[l];
                if (u.offsetTop > s) {
                    t || (t = u);
                    break
            ...
            if (t) {
                ...
                if (p && p !== a && (a && a.classList.remove("active"), p.classList.add("active"), a = p, !ue && y.classList.contains("sticky"))) {
    ...
    function me(e, t) {
        if (t) {
            var n, r = w("#" + t);
            r && (n = r, pe && pe.stop(), he = !1, pe = new le({
        ...
        ! function(e, r) {
            ...
            for (; t = n[a++];) {
                var s = function(n) {
                    return function(e) {
                        var t;
                        e && ("markdown" === n.embed.type ? t = i.lexer(e) : "code" === n.embed.type ? t = i.lexer("```" + n.embed.lang + "\n" + e.replace(/`/g, "@DOCSIFY_QM@") + "\n```\n") : "mermaid" === n.embed.type ? (t = [{
                                type: "html",
    ...
    function we(e, t, n) {
        var r, i, a;
        return t = "function" == typeof n ? n(t) : "string" == typeof n ? (i = [], a = 0, (r = n).replace(j, function(t, e, n) {
            i.push(r.substring(a, n - 1)), a = n += t.length + 1, i.push(function(e) {
                return ("00" + ("string" == typeof z[t] ? e[z[t]]() : z[t](e))).slice(-t.length)
            })
        }), a !== r.length && i.push(r.substring(a)), function(e) {
            for (var t = "", n = 0, r = e || new Date; n < i.length; n++) t += "string" == typeof i[n] ? i[n] : i[n](r);
            return t
    ...
    function _e(e) {
        ...
        var n, r, i, a, o, s = t.el || "#app",
            ...
            p = y;
        if (c) {
            if (t.repo && (u += (a = t.repo) ? (/\/\//.test(a) || (a = "https://github.com/" + a), '<a href="' + (a = a.replace(/^git\+/, "")) + '" class="github-corner" aria-label="View source on Github"><svg viewBox="0 0 250 250" aria-hidden="true"><path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path><path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path><path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path></svg></a>') : ""), t.coverpage && (u += (i = ", 100%, 85%", '<section class="cover show" style="background: linear-gradient(to left bottom, hsl(' + (Math.floor(255 * Math.random()) + i) + ") 0%,hsl(" + (Math.floor(255 * Math.random()) + i) + ') 100%)"><div class="cover-main">\x3c!--cover--\x3e</div><div class="mask"></div></section>')), t.logo) {
                var h = /^data:image/.test(t.logo),
                    d = /(?:http[s]?:)?\/\//.test(t.logo),
                    g = /^\./.test(t.logo);
                h || d || g || (t.logo = J(e.router.getBasePath(), t.logo))
            }
            u += (r = '<button class="sidebar-toggle"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><aside class="sidebar">' + ((n = t).name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (n.logo ? "<img alt=" + n.name + " src=" + n.logo + ">" : n.name) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>', (m ? r + "<main>" : "<main>" + r) + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'), e._renderTo(c, u, !0)
        } else e.rendered = !0;
        t.mergeNavbar && m ? p = w(".sidebar") : (l.classList.add("app-nav"), t.repo || l.classList.add("no-badge")), t.loadNavbar && A(p, l), t.themeColor && (b.head.appendChild(_("div", (o = t.themeColor, "<style>:root{--theme-color: " + o + ";}</style>")).firstElementChild), function(n) {
        ...
        }(t.themeColor)), e._updateRender(), $(y, "ready")
    }
    var Se = {};
    var Ae = function(e) {
        this.config = e
    ...
    Ae.prototype.getBasePath = function() {
        ...
        }(e, i.alias) : e, n = e, r = o, e = (e = new RegExp("\\.(" + r.replace(/^\./, "") + "|html)$", "g").test(n) ? n : /\/$/g.test(n) ? n + "README" + r : "" + n + r) === "/README" + o && i.homepage || e, e = X(e) ? e : J(a, e), t && (e = e.replace(new RegExp("^" + a), "")), e
    }, Ae.prototype.onchange = function(e) {
        void 0 === e && (e = p), e()
    }, Ae.prototype.getCurrentPath = function() {}, Ae.prototype.normalize = function() {}, Ae.prototype.parse = function() {}, Ae.prototype.toURL = function(e, t, n) {
        var r = n && "#" === e[0],
            i = this.parse(K(e));
    ...
    var Ee = function(r) {
        ...
        $e = function(t) {
            ...
            return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath = function() {
                ...
                void 0 === r && (r = p), C("click", function(e) {
    ...
    function Re(e) {
        var t, n, r;
        t = "button.sidebar-toggle", e.router, n = function(e) {
            return y.classList.toggle("close")
        }, C(t = v(t), "click", function(e) {
            e.stopPropagation(), n()
        }), m && C(y, "click", function(e) {
            return y.classList.contains("close") && n()
        }), r = ".sidebar", e.router, C(r = v(r), "click", function(e) {
            var t = e.target;
            "A" === t.nodeName && t.nextSibling && t.nextSibling.classList.contains("app-sub-sidebar") && $(t.parentNode, "collapse")
        }), e.config.coverpage ? !m && C("scroll", ae) : y.classList.add("sticky")
    }
    function Pe(t, n, r, i, a, e) {
        t = e ? t : t.replace(/\/$/, ""), (t = Q(t)) && F(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function(e) {
            return Pe(t, n, r, i, a)
        })
    }
    ...
    var Ne, je, ze, Me, qe = Fe.prototype;
    qe._init = function() {
        var n, t, r, e, i, a = this;
        a.config = function() {
            var e = d({
                el: "#app",
                repo: "",
                ...
                t = document.currentScript || [].slice.call(document.getElementsByTagName("script")).filter(function(e) {
                    return /docsify\./.test(e.src)
                })[0];
            if (t) {
                for (var n in e) if (l.call(e, n)) {
        ...
        }(), (n = a)._hooks = {}, n._lifecycle = {}, ["init", "mounted", "beforeEach", "afterEach", "doneEach", "ready"].forEach(function(e) {
            var t = n._hooks[e] = [];
        ...
        }), h(a, "init"), i = (r = a).config, e = "history" === (i.routerMode || "hash") && g ? new $e(i) : new Ee(i), r.router = e, Te(r), Le = r.route, e.onchange(function(e) {
        ...
        function(t) {
            ...
            if (t.rendered) {
                ...
                e && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__), t._bindEventOnRendered(n), t.$resetEvents(), h(t, "doneEach"), h(t, "ready")
            } else t.$fetch(function(e) {
                    return h(t, "ready")
                })
        }(a), h(a, "mounted")
    }, qe.route = {}, (Ne = qe)._renderTo = function(e, t, n) {
        var r = v(e);
        ...
        h(this, "beforeEach", r, function(e) {
            var t, n = function() {
                    i.updatedAt && (t = we(t, i.updatedAt, o.config.formatUpdated)), h(o, "afterEach", t, function(e) {
                        return xe.call(o, e)
                    })
                };
            o.isHTML ? (t = o.result = r, n(), a()) : ye({
                compiler: o.compiler,
                raw: e
            }, function(e) {
        ...
        if ($(v("main"), t ? "add" : "remove", "hidden"), e) {
            ...
            if (i) {
                if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
                    ...
                    var a = i[1];
                    $(n, "add", "has-mask"), X(i[1]) || (a = J(this.router.getBasePath(), i[1])), n.style.backgroundImage = "url(" + a + ")", n.style.backgroundSize = "cover", n.style.backgroundPosition = "center center"
                }
                r = r.replace(i[0], "")
            }
        ...
        ! function(e) {
            var t = v(".app-name-link"),
                n = e.config.nameLink,
                r = e.route.path;
            if (t) if (c(e.config.nameLink)) t.setAttribute("href", n);
        ...
        if (n) {
            ...
            return o ? (o = this.router.getFile(a + o), this.coverIsHTML = /\.html$/g.test(o), F(o + G(i, ["id"]), !1, r).then(function(e) {
        ...
        return Me(c + r, 0, t).then(function(e, t) {
        ...
        if (s) {
            ...
            return Me(this.router.getFile(c), 0, o).then(function(e, t) {
        ...
        slugify: U,
        version: "4.8.6"
    }, window.DocsifyCompiler = re, window.marked = M, window.Prism = a,
    function(e) {
