!function() {
    ...
    function c(e) {
        ...
        Object.keys(d).forEach(function(n) {
            i = i.concat(Object.keys(d[n]).map(function(e) {
                return d[n][e]
            }))
        });
        ...
        function n(e) {
            var n = i[e]
              ...
              , t = n.slug || "";
            if (d && (r.forEach(function(e) {
                var n, t = new RegExp(e.replace(/[|\\{}()[\]^$+*?.]/g, "\\$&"),"gi"), a = -1;
                if (n = d ? d.search(t) : -1,
                a = l ? l.search(t) : -1,
                0 <= n || 0 <= a) {
                    s += 0 <= n ? 3 : 0 <= a ? 2 : 0,
                    ...
                    var r = "..." + h(l).substring(o, i).replace(t, '<em class="search-keyword">' + e + "</em>") + "...";
                    c += r
                }
            }),
            0 < s)) {
    ...
    function i(t, a) {
        ...
        if (d = JSON.parse(localStorage.getItem(i)),
        n)
            d = {};
        else if (!e)
            return;
        ...
        r.forEach(function(n) {
            ...
            Docsify.get(a.router.getFile(n), !1, a.config.requestHeaders).then(function(e) {
                d[n] = function(n, e, t, a) {
                    void 0 === e && (e = "");
                    var o, i = window.marked.lexer(e), r = window.Docsify.slugify, s = {};
                    return i.forEach(function(e) {
                        if ("heading" === e.type && e.depth <= a)
                            ...
                            if (!o)
                                return;
                            s[o] ? s[o].body ? s[o].body += "\n" + (e.text || "") : (e.text || "table" === e.type && (e.text = e.cells.map(function(e) {
                                return e.join(" | ")
                            }).join(" |\n ")),
                            s[o].body = s[o].body ? s[o].body + e.text : e.text) : s[o] = {
                                slug: o,
                                title: "",
                                body: ""
                            }
    ...
    function o(e) {
        ...
        if (!e)
            ...
            t.innerHTML = "",
            void (p.hideOtherSidebarContent && (o.classList.remove("hide"),
        ...
        p.hideOtherSidebarContent && (o.classList.add("hide"),
    ...
    function r(e, n) {
        ...
        function(e) {
            ...
            Docsify.dom.toggleClass(t, "search"),
            Docsify.dom.before(a, t)
        }(t),
        function() {
            var e, n = Docsify.dom.find("div.search"), t = Docsify.dom.find(n, "input"), a = Docsify.dom.find(n, ".input-wrap");
            ...
            Docsify.dom.on(a, "click", function(e) {
                "INPUT" !== e.target.tagName && (t.value = "",
                o())
            })
        }(),
    ...
    $docsify.plugins = [].concat(function(e, n) {
        var t = Docsify.util
          , a = n.config.search || u;
        Array.isArray(a) ? u.paths = a : "object" == typeof a && (u.paths = Array.isArray(a.paths) ? a.paths : "auto",
        ...
        u.hideOtherSidebarContent = a.hideOtherSidebarContent || u.hideOtherSidebarContent,
